...
// Объединить п.4 и п.5, пойти одним из вариантов:
// 1. Пройтись циклом по массиву увеличивая счетчик на 2 начиная с 1:
// for (int i = 1; i < array.Length; i += 2) 
// {
//     sum += array[i];
// }

// 2. Пройтись циклом по массиву проверяя четность счетчика:
